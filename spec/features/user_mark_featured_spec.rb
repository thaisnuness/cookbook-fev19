...
feature 'User mark featured recipe' do
  scenario 'successfully' do
    ...
    new_recipe = Recipe.create(title: 'Bolo de cenoura', difficulty: 'Médio',
                  ...
                  cook_method: 'Cozinhe a cenoura, corte em pedaços pequenos, misture com o restante dos ingredientes', featured: false, user: user)
  ...
  scenario 'unfeatured' do
    ...
    new_recipe = Recipe.create(title: 'Bolo de cenoura', difficulty: 'Médio',
                  recipe_type: recipe_type, cuisine: cuisine,
                  cook_time: 50, ingredients: 'Farinha, açucar, cenoura',
                  cook_method: 'Cozinhe a cenoura, corte em pedaços pequenos, misture com o restante dos ingredientes', featured: true, user: user)
